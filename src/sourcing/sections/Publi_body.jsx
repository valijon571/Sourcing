    ...
    <PublkStyle>
        <div className="publi_body">
            ...
            <div className="set_of">
                <button className="tag"> научное исследование <img src="/image/close-circle.png"/></button>
                <button className="tag">языки <img src="/image/close-circle.png"/></button>
                <button className="tag">интернет <img src="/image/close-circle.png"/></button>
